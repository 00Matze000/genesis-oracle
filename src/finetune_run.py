...
# Aktivierung von Low-Rank Adaptation (LoRA)
gemma_lm.backbone.enable_lora(rank=4)

# Dummy-Trainingsdaten formatieren
training_data = [
...
# Kompilierung des Modells mit optimierter Lernrate
gemma_lm.compile(
...
# Training für eine repräsentative Epoche
gemma_lm.fit(prompts, epochs=1, batch_size=2)

# Sichern des trainierten Adapters im VM-Speicher
gemma_lm.save_to_preset("./gemma4_lora_adapter")
print("Feintuning erfolgreich abgeschlossen. Gewichte gespeichert.")
